...
If a line contains a URL → source_url
If a line resembles a date → publish_date
...
Rewrite transcript fragments into clear readable sentences while preserving meaning.

Remove filler words such as:
um, uh, repeated fragments, and transcription artifacts.

Do not remove meaningful content.

STEP 4 — Identify Major Themes
...
STEP 5 — Build a Lecture-Quality Outline

Create a hierarchical outline using Roman numerals and indentation.
...
STEP 7 — Extract Reference Information
...
STEP 8 — Create an Expected Outcome Section
...
<lecture-quality hierarchical outline>
